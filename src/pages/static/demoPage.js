...
<div class="welcome-screen" id="welcomeScreen">
  <div class="w-eyebrow">Interactive Demo</div>
  <h1 class="w-title">See Empire <span>HomePath</span><br/>in Action</h1>
  <p class="w-sub">Experience the platform that gives New York's real estate and mortgage professionals instant access to every homebuyer assistance program in the state.</p>
  <div class="w-steps">
    <div class="w-step"><div class="w-step-num">1</div><div class="w-step-label">Select County</div></div>
    <div class="w-step"><div class="w-step-num">2</div><div class="w-step-label">Browse Programs</div></div>
    <div class="w-step"><div class="w-step-num">3</div><div class="w-step-label">Program Details</div></div>
    <div class="w-step"><div class="w-step-num">4</div><div class="w-step-label">Generate Report</div></div>
    <div class="w-step"><div class="w-step-num">5</div><div class="w-step-label">Choose a Plan</div></div>
  </div>
  <button class="btn-subscribe-big" onclick="startDemo()">Start the Demo →</button>
  <div class="w-note">Demo uses sample data · Subscribe for full access to all 62 counties</div>
</div>

<!-- NAV -->
<nav class="demo-nav">
  <a href="/" class="demo-nav-logo">Empire<span>Home</span>Path</a>
  <div class="demo-nav-right">
    <div class="demo-badge">Sample Demo</div>
    <button class="demo-restart" onclick="restartDemo()">Restart</button>
  </div>
</nav>

<!-- PROGRESS -->
<div class="demo-progress">
  <div class="prog-step" id="prog-1"><div class="prog-num">1</div><div class="prog-label">Select County</div></div>
  <div class="prog-step" id="prog-2"><div class="prog-num">2</div><div class="prog-label">Browse Programs</div></div>
  <div class="prog-step" id="prog-3"><div class="prog-num">3</div><div class="prog-label">Program Details</div></div>
  <div class="prog-step" id="prog-4"><div class="prog-num">4</div><div class="prog-label">Generate Report</div></div>
  <div class="prog-step" id="prog-5"><div class="prog-num">5</div><div class="prog-label">Get Full Access</div></div>
</div>
...
<div class="step-panel active" id="step-1">
  <div class="step-header">
    ...
    <h2 class="step-title">Choose Your <span>County</span></h2>
    <p class="step-subtitle">Empire HomePath covers all 62 New York counties. Select one below along with your buyer's income and purchase price to see matching programs.</p>
  </div>
    ...
    <div class="step1-grid">
      <div style="display:flex;flex-direction:column;gap:16px;">
        <div class="field-group">
          ...
          <div class="select-wrap">
            <select class="field-select" id="countySelect" onchange="onCountySelect()">
        ...
        <div id="extraFields" style="display:none;display:flex;flex-direction:column;gap:16px;">
          <div class="form-row">
            <div class="field-group">
              <div class="field-label">Household Income</div>
              <div class="select-wrap">
                <select class="field-select" id="incomeSelect">
            ...
            <div class="field-group">
              ...
              <div class="select-wrap">
                <select class="field-select" id="priceSelect">
                  <option value="">— Select range —</option>
          ...
          <div class="form-row">
            <div class="field-group">
              <div class="field-label">Buyer Type (Optional)</div>
              <div class="select-wrap">
                <select class="field-select" id="buyerType">
            ...
            <div class="field-group">
              <div class="field-label">Program Type (Optional)</div>
              <div class="select-wrap">
                <select class="field-select" id="programType">
      ...
      <div>
        ...
        <div class="stats-panel">
          <div class="stats-panel-header"><div class="stats-dot"></div><div class="stats-panel-title">New York State — Full Platform</div></div>
          <div class="stats-grid">
            <div class="stat-cell"><div class="stat-num">62</div><div class="stat-label">Counties Covered</div></div>
            <div class="stat-cell"><div class="stat-num">500+</div><div class="stat-label">Active Programs</div></div>
            <div class="stat-cell"><div class="stat-num">7</div><div class="stat-label">Program Categories</div></div>
            <div class="stat-cell"><div class="stat-num green">Live</div><div class="stat-label">Continuously Updated</div></div>
          </div>
        </div>
        <!-- Gated fact -->
        <div class="gated-fact">
          <div class="gated-fact-inner">
            <div class="gated-fact-label">Professional Insight</div>
            <div class="gated-fact-text">New York State has one of the highest concentrations of DPA programs in the country. The average eligible buyer in a mid-size NY county qualifies for 3 to 5 programs simultaneously — but fewer than 12% of real estate and mortgage professionals can name them all. Empire HomePath closes that gap in seconds.</div>
          </div>
          <div class="gated-overlay">
            <div class="gated-overlay-text">🔒 Subscribe to unlock professional insights</div>
            <a href="/#pricing" class="btn-gate">View Plans</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="step-footer">
    <div class="step-hint">This demo uses sample data — subscribe for live results</div>
    <div class="step-nav">
      <button class="btn-next" id="step1Next" onclick="goToStep(2)" disabled>
...
<div class="step-panel" id="step-2">
  <div class="step-header">
    ...
    <h2 class="step-title">Sample Programs — <span id="s2county">Your County</span></h2>
    <p class="step-subtitle">This is a sample of what subscribers see instantly. Full program names, amounts, and funding status — for every county, every time.</p>
  </div>
  <div class="step-content" id="step2Content"></div>
  <div class="step-footer">
    <div class="step-hint">Subscribers see all programs with full contact details and eligibility rules</div>
    <div class="step-nav">
      <button class="btn-back" onclick="goToStep(1)">← Back</button>
      <button class="btn-next" id="step2Next" onclick="goToStep(3)" disabled>
...
<div class="step-panel" id="step-3">
  <div class="step-header">
    ...
    <h2 class="step-title" id="s3title">Program <span>Details</span></h2>
    <p class="step-subtitle">Subscribers see complete eligibility rules, income limits, contact information, and application links — all verified and current.</p>
  </div>
  <div class="step-content" id="step3Content"></div>
  <div class="step-footer">
    <div class="step-hint">Full agency contact details and application links available to subscribers only</div>
    <div class="step-nav">
...
<div class="step-panel" id="step-4">
  <div class="step-header">
    ...
    <h2 class="step-title">Client-Ready <span>PDF Report</span></h2>
    <p class="step-subtitle">One click. A professional report your buyer can read — with every matching program, their amounts, and next steps. Subscribers can download and white-label all reports.</p>
  </div>
  <div class="step-content">
    <div id="reportLoading" class="loading-state">
      <div class="spinner"></div>
      <div class="loading-text" id="loadingText">Compiling sample programs…</div>
    </div>
    <div id="reportContent" style="display:none;">
      <div class="report-wrap">
        <div class="report-preview">
          <div class="report-watermark"><div class="report-watermark-text">SAMPLE<br/>DEMO</div></div>
          <div class="report-header">
            <div class="report-logo">Empire<span>Home</span>Path</div>
            <div class="report-date" id="reportDate"></div>
          </div>
          <div class="report-body">
            <div class="report-county" id="reportCounty"></div>
            <div class="report-sub">Sample Programs · For Demonstration Only</div>
            <div id="reportRows"></div>
            <div style="margin-top:14px;padding:12px 14px;background:#f5f5f5;border-radius:4px;font-size:11px;color:#999;line-height:1.5;">SAMPLE REPORT — Data shown for demonstration purposes only. Subscribe to Empire HomePath for verified program data, full eligibility details, agency contacts, and downloadable PDF reports.</div>
          </div>
          <div class="report-footer-bar">Empire HomePath LLC · empirehomepath.com · Sample Data — Not for Client Distribution</div>
        </div>
        <div class="report-gate">
          <div class="report-gate-title">🔒 Download the Real Report</div>
          <div class="report-gate-sub">Subscribers can download, save, and share professional reports with their buyers — with your firm's branding on every page.</div>
          <a href="/#pricing" class="btn-subscribe-big">Subscribe to Download</a>
        </div>
      </div>
    </div>
  </div>
  <div class="step-footer">
    <div class="step-hint">Watermarked sample only — subscribers get clean downloadable PDFs</div>
    <div class="step-nav">
      <button class="btn-back" onclick="goToStep(3)">← Back</button>
      <button class="btn-next" onclick="goToStep(5)">
        Choose Your Plan
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
      </button>
    </div>
...
<div class="step-panel" id="step-5">
  <div class="step-header">
    ...
    <h2 class="step-title">Get <span>Full Access</span></h2>
    <p class="step-subtitle">You just saw a sample. Subscribers get every program, in every county, with full eligibility details, contact info, and PDF export — updated continuously.</p>
  </div>
  <div class="step-content">
    <div class="plan-grid">
      <div class="plan-card">
        <div class="plan-tier">Individual</div>
        <div class="plan-price"><span class="plan-curr">$</span>150</div>
        <div class="plan-period">per month</div>
        <div class="plan-divider"></div>
        <ul class="plan-feats">
          <li><span class="ck">+</span>All 62 counties — full access</li>
          <li><span class="ck">+</span>Unlimited program searches</li>
          <li><span class="ck">+</span>Client-ready PDF reports</li>
          <li><span class="ck">+</span>Program status alerts</li>
          <li><span class="ck">+</span>Email support</li>
        </ul>
        <button class="btn-plan btn-plan-outline" onclick="selectPlan('Individual')">Get Started</button>
      </div>
      <div class="plan-card featured">
        <div class="plan-badge">Most Popular</div>
        <div class="plan-tier">Professional</div>
        <div class="plan-price"><span class="plan-curr">$</span>375</div>
        <div class="plan-period">per month</div>
        <div class="plan-divider"></div>
        <ul class="plan-feats">
          <li><span class="ck">+</span>Everything in Individual</li>
          <li><span class="ck">+</span>White-label client reports</li>
          <li><span class="ck">+</span>Branded PDF exports</li>
          <li><span class="ck">+</span>Priority data updates</li>
          <li><span class="ck">+</span>CRM export (CSV)</li>
          <li><span class="ck">+</span>Priority support</li>
        </ul>
        <button class="btn-plan btn-plan-gold" onclick="selectPlan('Professional')">Get Started</button>
      </div>
      <div class="plan-card">
        <div class="plan-tier">Enterprise</div>
        <div class="plan-price" style="font-size:32px;line-height:1.2;">Custom</div>
        <div class="plan-period">team pricing</div>
        <div class="plan-divider"></div>
        <ul class="plan-feats">
          <li><span class="ck">+</span>Platform under your brand</li>
          <li><span class="ck">+</span>Multi-user team access</li>
          <li><span class="ck">+</span>API data integration</li>
          <li><span class="ck">+</span>Dedicated account manager</li>
          <li><span class="ck">+</span>Custom onboarding</li>
        </ul>
        <button class="btn-plan btn-plan-outline" onclick="selectPlan('Enterprise')">Contact Us</button>
      </div>
    </div>
    <div style="text-align:center;margin-top:24px;padding:18px;background:var(--ink-mid);border:1px solid var(--border);border-radius:8px;max-width:520px;margin-left:auto;margin-right:auto;">
      <div style="font-family:'DM Mono',monospace;font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:var(--gold);opacity:0.7;margin-bottom:6px;">Stop Searching. Start Closing.</div>
      <div style="font-size:13px;color:var(--body);line-height:1.65;">Questions? Email us at <a href="mailto:empirehomepath@gmail.com" style="color:var(--gold);text-decoration:none;font-weight:600;">empirehomepath@gmail.com</a></div>
    </div>
  </div>
  <div class="step-footer">
    <div class="step-hint">No long-term contracts — cancel any time</div>
    <div class="step-nav">
...
<div class="success-overlay" id="successOverlay">
  <div style="font-size:56px;margin-bottom:20px;animation:pop 0.5s cubic-bezier(0.175,0.885,0.32,1.275);">🔑</div>
  <h2 class="success-title">Welcome to Empire <span>HomePath</span></h2>
  <p class="success-sub">You are one step away from full access to all 62 New York counties. We will be in touch within one business day to complete your setup.</p>
  <button class="btn-close-success" onclick="document.getElementById('successOverlay').classList.remove('show')">Back to Demo</button>
  @keyframes pop{from{transform:scale(0);}to{transform:scale(1);}}
</div>`,
  scripts: `// ══ SAMPLE DATA — fixed regardless of county selected ══
